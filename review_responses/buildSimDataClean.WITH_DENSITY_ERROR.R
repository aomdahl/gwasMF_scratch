...
### ERROR: something happened, no dense factors are here now.
### Move these to the above, and then update the necessary files- still useful information.
...
### updated on Sept 25 to omit the min of 5000
set.seed(061995)
mixed.nums <- c(floor(runif(6, min = 10000, max = 100000)),floor(runif(4, min = 100000, max = 200000)))
